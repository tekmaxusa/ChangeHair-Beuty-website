...
<body class="chb-body chb-subpage chb-admin-dashboard">
    <main class="chb-page-shell chb-admin-dash-shell">
        ...
        <div class="chb-panel chb-dashboard-panel">
            ...
            <p class="chb-book-intro" style="margin-top:0;">New <strong>client</strong> users can log in at <a href="/login.php">/login.php</a> with the password you set. Merchant admin accounts are not created here — use server configuration (<code>.env</code>) or the database.</p>
            ...
            <form method="post" class="chb-admin-user-form" style="max-width:22rem;">
                ...
                <button type="submit" class="chb-submit">Create client account</button>
            </form>
        </div>

        <div class="chb-panel chb-dashboard-panel" style="margin-top:1.5rem;">
            <h2 class="chb-section-title">All client accounts</h2>
            <p class="chb-book-intro" style="margin-top:0;">Customers who can log in at <a href="/login.php">/login.php</a> and book appointments.</p>
            <?php if ($clients === []): ?>
